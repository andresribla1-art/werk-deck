      ...
      <div className="flex h-full bg-[#0a0a0a] border border-white/5 rounded-sm overflow-hidden shadow-2xl">
        ...
        <aside className="w-1/3 border-r border-white/5 flex flex-col bg-[#050505]">
          <div className="p-6 border-b border-white/5">
            <h2 className="font-mono text-[10px] text-zinc-400 uppercase tracking-[0.2em] flex items-center justify-between">
              ...
              <span className="font-mono text-[9px] bg-white/5 px-1.5 py-0.5 rounded-sm text-zinc-400">3 ACTIVOS</span>
            </h2>
          </div>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-5 border-l-2 border-emerald-500 bg-white/[0.02] cursor-pointer">
              <div className="flex justify-between items-baseline mb-1">
                ...
                {/* FIX: zinc-500 a zinc-400 */}
                <span className="font-mono text-[9px] text-zinc-400">10:42 AM</span>
              </div>
              <p className="text-xs text-emerald-400 font-mono truncate">CyberShield Solutions</p>
              {/* FIX: zinc-500 a zinc-400 */}
              <p className="text-xs text-zinc-400 font-light mt-2 truncate">Revisamos tu ejecución en la Arena...</p>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 flex flex-col relative">
          ...
          <header className="p-6 border-b border-white/5 bg-[#0a0a0a] flex justify-between items-center">
            ...
            {/* FIX: zinc-500 a zinc-400 */}
            <button className="text-zinc-400 hover:text-zinc-200 font-mono text-[10px] tracking-widest transition-colors">
              VER OFERTA ORIGINAL
            </button>
          </header>
          ...
          <div className="flex-1 p-6 overflow-y-auto space-y-6">
            <div className="max-w-[80%]">
              ...
              {/* FIX: Fecha del mensaje, subimos de zinc-600 a zinc-400 para poder leerse */}
              <p className="text-[9px] font-mono text-zinc-400 mt-2 ml-1">HOY, 10:42 AM</p>
            </div>
          </div>
          ...
          <div className="p-6 bg-[#050505] border-t border-white/5">
            <div className="relative flex items-center">
              ...
              />
              {/* FIX: zinc-500 a zinc-400 */}
              <button className="absolute right-4 text-zinc-400 hover:text-emerald-400 font-mono text-[10px] uppercase tracking-[0.2em] transition-colors">
                SEND [⏎]
              </button>
            </div>
          </div>
