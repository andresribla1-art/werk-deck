...
export default function Messages() {
  return (
    <div className="min-h-screen bg-[#030406] text-zinc-100 font-sans p-6 md:p-8">
      <div className="max-w-[1440px] mx-auto bg-[#0c0d12] border border-zinc-800/80 rounded-2xl overflow-hidden shadow-2xl grid grid-cols-12 h-[760px]">
        {/* Left Side Active Encrypted Channels */}
